...
@Autonomous(name="JustMoveBlue", group="z")
//@Disabled

public class JustMoveAuto extends LinearOpMode {
...
//    private VisionPortal visionPortal;
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.MM,50,1140,AngleUnit.DEGREES,0);
...
//                    Launch.setVelocity(far);
                     ...
                     */
                    if (nav.driveTo(odo.getPosition(), TARGET_1, .6, .4)) {
