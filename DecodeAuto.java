...
//    private Limelight3A limelight;
    ...
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.MM, -1000, -300, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.MM,0,0, AngleUnit.DEGREES,0);
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM, -1300, 800, AngleUnit.DEGREES, 0);
...
//            telemetry.update();
            switch (stateMachine){
                ...
                case DRIVE_TO_TARGET_1:
                     ...
                     */
                    if (nav.driveTo(odo.getPosition(), TARGET_1, .6, 5)){
                ...
                case DRIVE_TO_TARGET_2:
                    ...
                    if (nav.driveTo(odo.getPosition(), TARGET_2, 1, 1)){
...
//                        sleep(500);
                ...
                case DRIVE_TO_TARGET_4:
                    if(nav.driveTo(odo.getPosition(),TARGET_4,.7,0)){
