...
@Autonomous(name="StateFarBlue9", group="blue")
//@Disabled

public class StateFarBlue9 extends LinearOpMode {
...
//shoot 1
    ...
    //intake 1
    static final Pose2D TARGET_3_Left = new Pose2D(DistanceUnit.MM, 640, 1150, AngleUnit.DEGREES, 90);

    static final Pose2D TARGET_3_5 = new Pose2D(DistanceUnit.MM, 200, 400, AngleUnit.DEGREES, 0);

    //shoot 2
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM, 50, 0, AngleUnit.DEGREES, 23);
    //ready to intake 2
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.MM, 1250, 300, AngleUnit.DEGREES, 90);
    //intake 2
    static final Pose2D TARGET_6 = new Pose2D(DistanceUnit.MM, 1250, 1150, AngleUnit.DEGREES, 90);
    //shoot 3
    static final Pose2D TARGET_7 = new Pose2D(DistanceUnit.MM, 0, 50, AngleUnit.DEGREES, 23);
    //park
    static final Pose2D TARGET_8 = new Pose2D(DistanceUnit.MM, 700, 0, AngleUnit.DEGREES, 0);
...
//
                ...
                case DRIVE_TO_TARGET_2_Left:
                    if (nav.driveTo(odo.getPosition(), TARGET_2_Left, .7, 0)) {
                ...
                case DRIVE_TO_TARGET_3_Left:
                    intake();
                    if (nav.driveTo(odo.getPosition(), TARGET_3_Left, .8, .5)) {
                        change = -320;
                        three=false;
                        telemetry.addLine("at position #2!");
...
//                        Launch.setVelocity(far);
                ...
                case DRIVE_TO_TARGET_3_5:
                    intake();
                    if (nav.driveTo(odo.getPosition(), TARGET_3_5, 1, 0)) {
//                        change=-320;
                        telemetry.addLine("at position #2!");
...
//                        Launch.setVelocity(far);
                ...
                case DRIVE_TO_TARGET_4:
                    if (nav.driveTo(odo.getPosition(), TARGET_4, 1, .1)) {
...
//                        launch2();
                ...
                case DRIVE_TO_TARGET_6:
                    intake();
                    if (nav.driveTo(odo.getPosition(), TARGET_6, .9, 0.1)) {
...
//        telemetry.addData("is three yes",three);
//        telemetry.addData("change2value",change2);
//        telemetry.update();
//        sleep(5000);
            Revolver.setTargetPosition(0 + change + change2);
            ...
            flick.setPosition(.3);
            change2 = -40;
            Revolver.setTargetPosition(320 + change + change2);
            Revolver.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Revolver.setPower(1);
            sleep(1100);
            if (change == 0) {
...
//        telemetry.update();
//        sleep(5000);
            Revolver.setTargetPosition(50 + change);
            Revolver.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Revolver.setPower(1);
            if (change == 0) {
                sleep(0);
...
//        Launch.setPower(.55);
        flick.setPosition(.3);
        Revolver.setTargetPosition(640+change+change2);
        Revolver.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        Revolver.setPower(.7);
        sleep(1600);
        flick.setPosition(.78);
