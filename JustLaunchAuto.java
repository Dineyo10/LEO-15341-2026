...
@Autonomous(name="JustLaunchBlue", group="z")
//@Disabled

public class JustLaunchAuto extends LinearOpMode {
...
//    private VisionPortal visionPortal;
    ...
    static final Pose2D TARGET_2_Left = new Pose2D(DistanceUnit.MM, 20, 500, AngleUnit.DEGREES, 0);
...
//                    launch1();
                     ...
                     */
                    if (nav.driveTo(odo.getPosition(), TARGET_1, .4, .4)) {
...
//
                ...
                case DRIVE_TO_TARGET_2_Left:
                    if (nav.driveTo(odo.getPosition(), TARGET_2_Left, .7, 30)){
...
//                        SpinUpshort();
                ...
                case DRIVE_TO_TARGET_5:
                    if(nav.driveTo(odo.getPosition(),TARGET_5,.7,4)){
